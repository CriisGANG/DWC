...
function generarRecibo(recibo) {
    ...
    for (let i = 0; i < recibo.length; i++) {
        ...
        console.log(`${nombreProducto} | ${cantidad} | ${precioUnitario} | ${subtotalStr}`);
...
generarRecibo(recibos[0]);

generarRecibo(recibos[1]);

generarRecibo(recibos[2]);

generarRecibo(recibos[3]);